...
| **Google Cloud Storage** | Uploads generated cover art bytes to a public GCS bucket (`book-concierge-media-*`) and returns HTTPS URLs for rich card rendering. | [`app/agent.py`](file:///config/Desktop/Session1/book-concierge-agent/app/agent.py) |

...
def get_memory_service():
    ...
    agent_engine_id = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID") or os.environ.get("MEMORY_BANK_ID") or "6547857825220001792"
    if agent_engine_id:
        from google.adk.memory import VertexAiMemoryBankService

        return VertexAiMemoryBankService(
            project=os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-01-8ed423a30a4f"),
            location="us-east1",
            agent_engine_id=agent_engine_id,
        )
